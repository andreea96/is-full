function ISLAB_8B(N,sigma,lambda) 
%
...
FIG = 1;                             
identMethod = input("Ce algorirm recursiv de identificare doriti a folosi?(recursiveARX, riv, rpem, rplr, arx_nabla, arx_KB,rarx_e,rarx_r)");
% 
% Faults preventing
% ~~~~~~~~~~~~~~~~~
if (nargin < 3)
...
elseif(func2str(identMethod) == "rarx_r")
    [theta,ypred] = identMethod(D,[2 2 1],'ff',1,1) ; 
else
